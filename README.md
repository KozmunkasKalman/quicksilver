...
> [!WARNING]
> The Quicksilver compiler (qsl) is currently very early in development, as of the latest commit its only able to handle exit coes, and 1 byte unsigned integer variables on the stack.
